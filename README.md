...
马尔可夫过程是一种具有“无后效性”的随机过程，即未来状态只依赖于当前状态，而与过去状态无关。数学上，马尔可夫过程满足：
$$
P(X 
_{n+1}
​
...
- 混淆矩阵：比较了机器学习模型和 MRF 优化后的分类结果。
- ROC 曲线：展示了分类模型的 ROC 曲线和 AUC 值。

##### 3.2.1 无MRF机器学习分类结果

![Figure_5](E:\Figure_5.png)

​                 **图1** 无MRF机器学习分类 Accuracy over Epochs 和 Loss over Epochs 曲线图

<img src="E:\Figure_5_confusion.png"  width="400" />

​                                          **图2** 无MRF机器学习分类的混淆矩阵

<img src="E:\Figure_5_curve.png"  width="500" />

​                                               **图3** 无MRF机器学习分类的ROC曲线

曲线越接近左上角，模型的性能越好。

##### 3.2.2 MRF优化后的机器学习分类结果

<img src="E:\Figure_6_confusion.png"  width="400" />

​                                         **图4** MRF优化后机器学习分类的混淆矩阵
...
![image-20250422194624970](C:\Users\ASUS\AppData\Roaming\Typora\typora-user-images\image-20250422194624970.png)实验结果表明，MRF 优化显著提升了机器学习模型的分类性能。MRF 能够有效捕捉图像间的空间依赖关系，从而减少分类错误。
